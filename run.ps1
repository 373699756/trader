...
function Show-Usage {
    @"
用法: .\run.ps1 [serve|validate-config|research-status|research-history-download|research-backtest|research-r6-screen|research-r6-daily-screen|research-r7-dossier]
...
if ($Mode -in @("validate-config", "research-status", "research-history-download", "research-backtest", "research-r6-screen", "research-r6-daily-screen", "research-r7-dossier")) {
