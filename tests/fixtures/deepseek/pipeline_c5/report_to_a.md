# Pipeline C5 Final Sign-off to A
...
owned_paths_changed:
  ...
  - tests/fixtures/deepseek/pipeline_c5/report_to_a.md
contract_assumptions:
  - docs/reports/pipeline-g4-gate-review.md formally publishes G4 before C5 started.
...
contract-document, CHANGELOG or final-pipeline files and did not stage, commit or push. A must include this report and
the listed C-owned patch in its single A5 pipeline commit, rerun the final repository/package/wheel gates, and publish
