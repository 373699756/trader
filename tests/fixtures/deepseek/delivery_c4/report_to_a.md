...
owned_paths_changed:
  ...
  - tests/component/test_delivery_deepseek_c4.py
  - tests/fixtures/deepseek/delivery_c4/report_to_a.md
contract_assumptions:
  - docs/reports/delivery-g3-gate-review.md publishes G3 and leaves stage 4 for the next user instruction.
...
tests_run_and_results:
  - .venv/bin/python -m pytest tests/component/test_delivery_deepseek_c4.py -q: 7 passed.
  - .venv/bin/python -m pytest tests/unit/test_v2_deepseek_base.py tests/component/test_v2_deepseek.py tests/component/test_v2_deepseek_v4.py tests/component/test_delivery_deepseek_c2.py tests/component/test_delivery_deepseek_c3.py tests/component/test_delivery_deepseek_c4.py -q: 98 passed.
  ...
  - .venv/bin/python -m ruff check src/trader/infra/deepseek tests/component/test_delivery_deepseek_c4.py: passed.
  - .venv/bin/python -m mypy src/trader/infra/deepseek src/trader/domain/review tests/component/test_delivery_deepseek_c4.py: passed (23 source files).
