...
owned_paths_changed:
  ...
  - tests/component/test_pipeline_deepseek_c2.py
contract_assumptions:
  - CONTRACT_BASE=45bd2fab992d36eb873b7c448fbd9739f0cad43c from docs/reports/pipeline-g1-contract-base.md
...
- Source gate: `docs/reports/pipeline-g1-contract-base.md`
...
- Public config and application caller alignment for removing long budget/config exposure remain A-owned; C enforces long isolation inside the DeepSeek reviewer and budget ledger.
