...
- `tests/performance/run_delivery_b4_market.py`
- `tests/fixtures/market_data/delivery_b4/acceptance.json`
...
- `PYTHONPATH=src .venv/bin/python tests/performance/run_delivery_b4_market.py --config config/v2/runtime.json --fixture tests/fixtures/performance/v15 --output /tmp/delivery_b4_acceptance_f01.json` passed.
- `PYTHONPATH=src .venv/bin/python tests/performance/run_v16_board_scoring.py --config config/v2/runtime.json --fixture tests/fixtures/performance/v16 --output /tmp/delivery_b4_scoring.json` passed.
