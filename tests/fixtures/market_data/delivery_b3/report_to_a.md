...
- `tests/fixtures/market_data/delivery_b3/columnar_baseline.json`
- `tests/fixtures/market_data/delivery_b3/report_to_a.md`

contract_assumptions:

- A3 integration handoff is available in `docs/reports/delivery-a3-integration.md`.
...
- `PYTHONPATH=src .venv/bin/python tests/performance/run_v15_market_data.py --config /home/cp/Public/trader/config/v2/runtime.json --fixture /home/cp/Public/trader/tests/fixtures/performance/v15 --output /tmp/delivery_b3_v15_market_data_report.json` passed.
- 100 tick columnar dirty/RSS script passed and produced `tests/fixtures/market_data/delivery_b3/columnar_baseline.json`.
