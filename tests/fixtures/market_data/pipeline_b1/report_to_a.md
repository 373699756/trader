...
- `tests/fixtures/market_data/pipeline_b1/report_to_a.md`
- `tests/fixtures/market_data/pipeline_b1/scalar_baseline.json`
...
- `PYTHONPATH=src .venv/bin/python tests/performance/run_v15_market_data.py --config /home/cp/Public/trader/config/v2/runtime.json --fixture /home/cp/Public/trader/tests/fixtures/performance/v15 --output /tmp/pipeline_b1_v15_market_data_report.json` passed.
...
- latest-wins：`gateway.py` 的 `_latest_snapshot/_latest_batch/_latest_changes`，`overlay_canonical_snapshot()`，`QuoteCache.update_candidate_quotes()`，source lane latest pending。
...
See `tests/fixtures/market_data/pipeline_b1/scalar_baseline.json`.
