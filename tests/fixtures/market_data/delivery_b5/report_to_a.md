...
The B4 report was also corrected to use the exact values already persisted in its acceptance JSON and its actual
...
`tests/fixtures/market_data/delivery_b5/market_acceptance.json` records a final no-network run on Python
3.14.4:
