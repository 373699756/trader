...
- `tests/fixtures/market_data/delivery_b2/columnar_baseline.json`
- `tests/fixtures/market_data/delivery_b2/report_to_a.md`
...
- `PYTHONPATH=src .venv/bin/python tests/performance/run_v15_market_data.py --config /home/cp/Public/trader/config/v2/runtime.json --fixture /home/cp/Public/trader/tests/fixtures/performance/v15 --output /tmp/delivery_b2_v15_market_data_ready_report.json` passed.
...
- Full metrics are in `tests/fixtures/market_data/delivery_b2/columnar_baseline.json`.
