...
def _measure(config_path: Path, fixture_path: Path) -> dict[str, Any]:
    ...
    return {
        "schema_version": "delivery-a4-integrated-memory-v1",
        "passed": passed,
        "identity": {
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the fixed delivery A4 integrated memory acceptance suite")
