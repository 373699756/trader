...
def test_challenger_registry_has_five_independent_immutable_variants() -> None:
    ...
    assert all(item.parameter_set_version == CHALLENGER_PARAMETER_SET_IDENTITY for item in variants)
