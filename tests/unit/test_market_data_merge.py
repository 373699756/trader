...
def _observation(
    ...
    *,
    ...
    return SourceObservation(
        ...
        data_version=data_version if data_version is not None else f"{source}-source",
        fields={
            "name": "测试股份",
            "price": price,
            "previous_close": 9.8,
...
def test_complete_realtime_columnar_projection_matches_scalar_field_merge() -> None:
    ...
    assert projection.source_versions == {"eastmoney": "eastmoney-source", "sina": "sina-source"}
...
def test_slow_source_cannot_overwrite_realtime_price_and_can_supply_board_identity() -> None:
    ...
    tushare = SourceObservation(
        ...
        data_version="tushare-master-initial",
        fields={
            "price": 99.0,
            "board": "main",
            "exchange": "SSE",
