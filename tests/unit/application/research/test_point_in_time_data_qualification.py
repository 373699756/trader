...
def test_current_archive_and_free_source_evidence_project_explicit_three_gate_blockers() -> None:
    ...
    report = assemble_point_in_time_data_qualification(archive, sources)
    ...
    assert "industry_effective_from_unavailable" in report.industry_sources[0].failure_reasons
