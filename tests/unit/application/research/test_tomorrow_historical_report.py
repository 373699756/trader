...
def _passing_metrics() -> TomorrowHistoricalGateMetrics:
...
def _passing_report() -> TomorrowHistoricalReport:
...
def test_p2_historical_report_can_only_authorize_later_forward_preregistration() -> None:
    ...
    assert report.schema_version == "score_tomorrow_historical_report"
