...
const els = {
  ...
  deepseekParticipation: document.getElementById("deepseekParticipation"),
  deepseekWeight: document.getElementById("deepseekWeight"),
  deepseekApiCallCount: document.getElementById("deepseekApiCallCount"),
  deepseekStrategyUsage: document.getElementById("deepseekStrategyUsage"),
  deepseekCoverage: document.getElementById("deepseekCoverage"),
  todayExecutionPhase: document.getElementById("todayExecutionPhase"),
  deepseekLastBatch: document.getElementById("deepseekLastBatch"),
  deepseekFailure: document.getElementById("deepseekFailure"),
