...
usage() {
  printf '%s\n' \
    "用法: ./run.sh [serve|validate-config|research-status|research-history-download|research-backtest|research-r6-screen]" \
    "" \
    "环境变量:" \
...
case "$MODE" in
  serve|app)
    ...
    ;;
  validate-config|research-status|research-history-download|research-backtest|research-r6-screen)
