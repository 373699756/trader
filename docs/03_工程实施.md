# 开发工作计划
怎么还有很多tomorrow_historical_p2_artifacts.py 这种P2 tomorrow_manual_v1_model.py V1,score_r6_daily_artifacts.py r6
tomorrow_p2_model.json  tomorrow_v1_model.json 这怎么p2 v1等，之前不是说其他都不要什么版本控制，只有评分v1/v2/v3的差一点放到v1/v2/v3目录吗尽量放到
