...
| --- | --- | --- | --- |
| A | `docs/reports/pipeline-a4-acceptance.md` | `yes; A4.1-A4.6 complete` | 正确性、故障、质量、兼容、性能、内存和资源证据齐全 |
| B | `tests/fixtures/market_data/pipeline_b4/report_to_a.md` | `yes` | scalar/columnar 等价、绝对预算、三板评分和 100 tick 内存通过 |
| C | `tests/fixtures/deepseek/pipeline_c4/report_to_a.md` | `yes` | 58/66/71 软目标、188 硬上限、重试/修复物理计数和保守合并通过 |
| D | `docs/reports/pipeline-d1-p6-web.md` 第 11 节 | `yes; D4-owned gates pass` | P6/SSE/API、增量传输和 Firefox 三档通过；原报告唯一跨 owner 阻塞已关闭 |
...
| P6 pipeline cache pool | `8,809,828` | `12,582,912` |
| P6 pipeline resident views | `2,806,645` | 已计入综合逻辑量 |
