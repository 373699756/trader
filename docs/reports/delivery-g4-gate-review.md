...
| --- | --- | --- | --- |
| A | `docs/reports/delivery-a4-acceptance.md` | `yes; A4.1-A4.6 complete` | 正确性、故障、质量、兼容、性能、内存和资源证据齐全 |
| B | `tests/fixtures/market_data/delivery_b4/report_to_a.md` | `yes` | scalar/columnar 等价、绝对预算、三板评分和 100 tick 内存通过 |
| C | `tests/fixtures/deepseek/delivery_c4/report_to_a.md` | `yes` | 58/66/71 软目标、188 硬上限、重试/修复物理计数和保守合并通过 |
| D | `docs/reports/delivery-d1-p6-web.md` 第 11 节 | `yes; D4-owned gates pass` | P6/SSE/API、增量传输和 Firefox 三档通过；原报告唯一跨 owner 阻塞已关闭 |
