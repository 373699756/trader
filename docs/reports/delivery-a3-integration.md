...
- B 的列式 dirty/change identity、C 的 V4 facts identity、D 的 projection identity 均收敛到
  `src/trader/application/ports/delivery.py` 已冻结的公共版本，不新增第二套公共 schema。
