...
公共基线版本：`delivery_contract_base_v1`。
...
B/C/D 的独占生产范围仍按 `docs/plan_delivery.md` 第 2.1 节执行。B/C/D 需要公共接口变化时，
...
| 报告 | 状态 |
| --- | --- |
| B1 P1-P3 盘点报告 | 已收到，路径 `tests/fixtures/market_data/delivery_b1/report_to_a.md`，`ready_for_gate=yes` |
| C1 DeepSeek 盘点报告 | 已收到，路径 `tests/fixtures/deepseek/delivery_c1/report_to_a.md`，`ready_for_gate=yes` |
| D1 P6/Web 盘点报告 | 已收到，路径 `docs/reports/delivery-d1-p6-web.md`，`ready_for_gate=yes` |
| CONTRACT_BASE | `45bd2fab992d36eb873b7c448fbd9739f0cad43c` |
| ready_for_gate | yes |

G1 发布记录见 `docs/reports/delivery-g1-contract-base.md`。B/C/D 阶段 2 均必须从同一
