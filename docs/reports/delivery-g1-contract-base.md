# delivery G1 CONTRACT_BASE 发布记录
...
| contract_commit_subject | `docs: freeze delivery A1 contracts` |
| published_by | Codex A |
| published_in | 本报告提交 |
| upstream_check | 发布前 `HEAD == @{upstream}` |
| stage_gate | G1 |

`CONTRACT_BASE` 指向已推送的 A1 契约冻结提交，包含 `delivery_contract_base_v1`、双层内存
...
| --- | --- | --- | --- |
| B | `tests/fixtures/market_data/delivery_b1/report_to_a.md` | `777e73d445f88c165126d1a09d02b833453b9d3e` | yes |
| C | `tests/fixtures/deepseek/delivery_c1/report_to_a.md` | `45bd2fab992d36eb873b7c448fbd9739f0cad43c` | yes |
| D | `docs/reports/delivery-d1-p6-web.md` | `45bd2fab992d36eb873b7c448fbd9739f0cad43c` | yes |
