...
VALIDATION_SNAPSHOT_MAX_QUOTE_AGE_SECONDS = int(os.getenv("VALIDATION_SNAPSHOT_MAX_QUOTE_AGE_SECONDS", "900"))
...
DEEPSEEK_RERANK_DISABLED_STRATEGIES = os.getenv(
    "DEEPSEEK_RERANK_DISABLED_STRATEGIES",
    "tech_potential,chokepoint_picks,reversal_picks,smallcap_value_picks,breakout_picks",
)
