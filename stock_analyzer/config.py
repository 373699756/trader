...
TOMORROW_STRATEGY_VERSION = os.getenv(
    ...
    "tomorrow_picks_v10_close_auction_baseline",
)
TOMORROW_CHALLENGER_STRATEGY_VERSION = os.getenv(
    "TOMORROW_CHALLENGER_STRATEGY_VERSION",
    "tomorrow_picks_v11_close_auction_challenger",
)
TOMORROW_CHALLENGER_MODE = os.getenv("TOMORROW_CHALLENGER_MODE", "shadow_only")
SWING_STRATEGY_VERSION = os.getenv("SWING_STRATEGY_VERSION", "swing_2_5d_v3_next_open_exit")
...
VALIDATION_AUTO_SNAPSHOT_TIME = os.getenv("VALIDATION_AUTO_SNAPSHOT_TIME", "14:50")
VALIDATION_CLOSE_ANCHOR_TIME = os.getenv("VALIDATION_CLOSE_ANCHOR_TIME", "15:00")
TOMORROW_SIGNAL_CUTOFF_TIME = os.getenv("TOMORROW_SIGNAL_CUTOFF_TIME", "14:55")
TOMORROW_CLOSE_AUCTION_START_TIME = os.getenv("TOMORROW_CLOSE_AUCTION_START_TIME", "14:55")
TOMORROW_CLOSE_AUCTION_END_TIME = os.getenv("TOMORROW_CLOSE_AUCTION_END_TIME", "15:00")
...
DEEPSEEK_DAILY_CALL_CAP = int(os.getenv("DEEPSEEK_DAILY_CALL_CAP", "30"))
DEEPSEEK_DAILY_PRO_CALL_CAP = int(os.getenv("DEEPSEEK_DAILY_PRO_CALL_CAP", "5"))
DEEPSEEK_LATE_MIN_INTERVAL_SECONDS = int(os.getenv("DEEPSEEK_LATE_MIN_INTERVAL_SECONDS", "60"))
...
VALIDATION_PRIMARY_ENTRY_MODE = os.getenv("VALIDATION_PRIMARY_ENTRY_MODE", "close_auction").lower()
...
ENABLE_TAIL_AUCTION_SLIPPAGE = os.getenv("ENABLE_TAIL_AUCTION_SLIPPAGE", "1").lower() in (
    "1",
    "true",
    "yes",
    "on",
...
PAYLOAD_CACHE_TTL_SECONDS = int(os.getenv("PAYLOAD_CACHE_TTL_SECONDS", "90"))
