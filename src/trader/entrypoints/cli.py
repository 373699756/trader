...
def build_parser() -> argparse.ArgumentParser:
    ...
    perf = subparsers.add_parser("perf-check", help="Run the fixed offline V2 performance acceptance suite.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    direct_handler = {"validate-config": _run_validate_config}.get(args.command)
