...
from trader.application.ports.tomorrow import TodayNativeInput, TomorrowNativeInput
...
def offer_scored_native_input(
    ...
    try:
        if strategy is Strategy.TODAY:
            ...
            raise ValueError("native input offer only supports Today and Tomorrow")
