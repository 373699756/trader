...
- Direct verification: `tests/unit/application/test_{cadence,schedule,workers,latest_wins,runtime}.py`, `tests/integration/test_scheduler_runtime.py`, and `tests/contract/test_runtime_contract.py`.
