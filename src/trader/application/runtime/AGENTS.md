...
- Own scheduling, cadence, source and strategy lanes, latest-wins workers, resource orchestration, shutdown deadlines, and typed runtime status.
...
- Direct verification: `tests/unit/application/test_{cadence,schedule,workers,latest_wins,runtime}.py`, `tests/integration/test_v2_scheduler_runtime.py`, and `tests/contract/test_v2_e3_runtime_contract.py`.
