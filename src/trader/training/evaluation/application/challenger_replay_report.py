"""Immutable challenger replay manifests and same-stock paired observations."""
...
from trader.training.evaluation.domain.challengers import ChallengerVariantId
from trader.training.evaluation.domain.historical import CostSettlementBasis, ResearchBoard
