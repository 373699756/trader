...
from trader.training.evaluation.domain.preregistered_rule_candidate import PreregisteredRuleCandidateFamily
...
def _hash(value: object) -> str:
    from trader.training.evaluation.domain.preregistered_rule_candidate import _hash as candidate_hash
