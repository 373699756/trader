"""V2 training application use case."""
...
class TrainV2UseCase(Generic[_ResultT]):
    """Run only the injected V2 runner; never performs I/O or model promotion itself."""
...
def train_v2(
    ...
    *,
    ...
    return TrainV2UseCase(runner).execute(
        history_root,
        train_root,
        progress=progress,
...
__all__ = ["TrainV2UseCase", "train_v2"]
