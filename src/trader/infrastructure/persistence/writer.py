...
from trader.infrastructure.persistence.writer_observability import RepositoryObservabilityMixin
from trader.infrastructure.persistence.writer_utils import (
